...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(36, 75);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(128, 39);
			this->button2->TabIndex = 2;
			this->button2->Text = L"button2";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &Administrativo3::button2_Click);
			// 
			// button3
			// 
			this->button3->Location = System::Drawing::Point(36, 142);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(128, 47);
			this->button3->TabIndex = 3;
			this->button3->Text = L"button3";
			this->button3->UseVisualStyleBackColor = true;
			this->button3->Click += gcnew System::EventHandler(this, &Administrativo3::button3_Click);
			// 
			// Administrativo3
			// 
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		con->mostrar(dataGridView1, "historiales");//cambiado
	}
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	con->mostrar(dataGridView1, "horarios");//cambiado
}
};
}
