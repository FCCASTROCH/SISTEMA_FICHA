...
namespace SalteñeriaSIS301 {
	...
	/// <summary>
	/// Resumen de inventario3
	/// </summary>
	public ref class inventario3 : public System::Windows::Forms::Form
	{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Text = L"Mostrar PACIENTES";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &inventario3::button1_Click);
			// 
			// inventario3
			// 
			...
			this->Name = L"inventario3";
			this->Text = L"inventario3";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		con->mostrar(dataGridView1, "reservas");//cambiado
	}
};
}
